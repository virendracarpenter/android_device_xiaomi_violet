git clone --depth=1 https://github.com/kibria5/android_vendor_xiaomi_violet -b udc vendor/xiaomi/violet
git clone --depth=1 https://github.com/kibria5/android_kernel_xiaomi_violet.git -b udc kernel/xiaomi/violet
